...
public class MenuBackgroundService : BackgroundService
{
    private readonly IWeather weather;

    public MenuBackgroundService(IWeather weather)
    {
    ...
    Task SelectCityAsync()
    {
        ...
        while(true)
        {
            ShowCities(weather.GetCityNames());
            ...
            if(weather.GetCityNames().Any(c => string.Equals(c, cityInput, StringComparison.InvariantCultureIgnoreCase)))
